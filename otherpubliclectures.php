...
<div id="content" >	
<div id="welcomeheader" style="margin-left: 0px; width:745px; border-bottom: 1px solid #b08b57;">other public lectures</div>
<p><a style="color: #000066;" align="left" href="javascript:history.go(-1)">Back</a></p>
	<div align="center" style="width:600px; height:auto; ">
    <a href="javascript:divHideShow('row1')"><h3 style="color:#000066;"><u>2013/2014 Academic Year</u></h3></a>
		<div id="row1" style="text-align: justify; padding-left: 30px; padding-top: 30px;">
	
	<?php 
		$query = mysql_query("SELECT * FROM public_lectures WHERE lect_type = 'OTHER PUBLIC LECTURES' AND academic_yr = '2013/2014' ORDER BY  lect_date DESC");
	...
	<td align="justify"><h3 style="color:#000066"><a href="<?php echo 'publiclectureintroduction.php' ; ?>?id=<?php echo $result['lecture_id']; ?>"><u><?php echo $title ; ?></u></a><br />	</h3>
	...
	<a href="javascript:divHideShow('row')"><h3 style="color:#000066;"><u>2012/2013 Academic Year</u></h3></a>
		<div id="row" style="text-align: justify; padding-left: 30px; padding-top: 30px;">
	
	<?php 
		$query = mysql_query("SELECT * FROM public_lectures WHERE lect_type = 'OTHER PUBLIC LECTURES' AND academic_yr = '2012/2013' ORDER BY  lect_date DESC");
		while($result = mysql_fetch_assoc($query)) {
		$title = $result['lect_title'];
		$title = html_entity_decode($title, ENT_QUOTES);
		$title = htmlspecialchars_decode($title);
