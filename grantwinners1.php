...
<div id="content">
	...
	<div id="welcomeheader">Grant Winners</div>
<p><a style="color: #000066;" align="left" href="javascript:history.go(-1)">Back</a></p>
	...
	<p><b>Please enter details below</b></p>
		...
		Grant Type:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;<input type="text" name="gt_type" value="" maxlength="256" /><br><br>
		Academic Year:&nbsp;&nbsp;&nbsp;&nbsp;	<input type="text" name="gt_year" value="" maxlength="256" /><br><br>
		...
		<table >
			...
			<tbody>
				...
				<textarea name="gt_content" rows="40" cols="80" style="width: 80%;"></textarea><br><br>

		

			<input type="submit" name="newgtsub" value="Submit" maxlength="50" />
