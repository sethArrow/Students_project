...
input[type=text]:focus {border-color:#333; }
	...
	input[type=textarea] {padding:5px; border:1px solid #ccc; 
-webkit-border-radius: 5px;
border-radius: 5px;
}
input[type=textarea]:focus {border-color:#333; }
...
<div id="header" align="center">
	...
	<form id="SignupForm" name="SignupForm"  method="POST" action="formpro.php">
	<!-- 1st Fieldset -->
	...
	<table align="center" style="border: 1px solid lightgray;">
		<tbody>
            ...
            <input type="hidden" name="office_phon" value="<?php echo $off_phone;?>" />
